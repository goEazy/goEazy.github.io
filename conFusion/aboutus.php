        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class = "active"><a href="aboutus.php"><span class="glyphicon glyphicon-info-sign"
                ...
                <div id = "history" class="row row-content">
                    <div class="col-xs-12 col-sm-6 col-lg-8">
                        ...
                        <div class="well">
                            ...
                            <footer>Yogi Bera,
                                <cite>Th Wit and Wisdom of Yogi Berra, P. Pepe, Diversion Books, 2014</cite>
                            </footer>
                            </blockquote>
                        </div>
                    </div>
                ...
                <div id = "corporate" class = "row row-content">
                    <div class="col-xs-12">
                        ...
                        <div class = "panel-group" id = "accordian" role = "tablist" aria-multiselectable="true">
                            <div class = "panel panel-default">
                                <div class="panel-heading" role="tab" id = "headingPeter">
                                    <h3 class="panel-title">
                                        <a role = "button" data-toggle = "collapse" data-parent="#accordian" href = "#peter"
                            ...
                            <div class = "panel panel-default">
                                <div role="tab" class="panel-heading" id = "headingDanny">
                                    <h3 class="panel-title">
                                        <a role="button" data-toggle = "collapse" href = "#danny" data-parent = "#accordian"
                            ...
                            <div class = "panel panel-default">
                                <div role="tab" class="panel-heading" id = "headingAgumbe">
                                    <h3 class="panel-title">
                                        <a role="button" data-toggle = "collapse" href = "#agumbe" 
                                           data-parent = "#accordian" aria-expanded="true" aria-controls="agumbe">
                        ...
                        <p>Blessed with the most discerning gustatory sense, Agumbe, our CFO, personally ensures that every dish that we serve meets his exacting tastes. Our chefs dread the tongue lashing that ensues if their dish does not meet his exacting standards. He lives by his motto, <em>You click only if you survive my lick.</em></p>
                            ...
                            <div class = "panel panel-default">
                                <div role="tab" class="panel-heading" id = "headingAlberto">
                                    <h3 class="panel-title">
                                        <a role="button" data-toggle = "collapse" href = "#alberto" data-parent = "#accordian">
